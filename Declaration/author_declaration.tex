...
\textbf{Zhanhong He (70\%)}, David Cooper (20\%), Defeng (David) Huang (5\%), Roberto Togneri (5\%),\\
...
\begin{tabular}{l}
\textbf{Details of the work:} \\
\textbf{Zhanhong He (70\%)}, Hanyu Meng (20\%), Defeng (David) Huang (5\%), Roberto Togneri (5\%),\\
...
Under review (\emph{Sound and Music Computing} Conference), 2026.\\
arXiv:2508.07757. DOI: 10.48550/arXiv.2508.07757.\\%[0.3cm]
\textbf{Location in thesis:} \\
{[insert chapter/section/page range, e.g., Chapter~X, Section~Y, pp.~AA--BB]}\\%[0.3cm]
\textbf{Student contribution to work:} \\
